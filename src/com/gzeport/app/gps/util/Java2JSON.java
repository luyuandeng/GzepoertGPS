...
public class Java2JSON {
	...
	public static String generate(java.util.Collection<?> list, int count) {
		...
		return StringUtils.convertEspecial(JSONObject.fromObject(map).toString());
	}
	...
	public static String generate(java.util.Collection<?> list, int count, JsonConfig jsonConfig) {
		...
		map.put("totalCount", count);
		map.put("topics", list);		
		return StringUtils.convertEspecial(JSONObject.fromObject(map, jsonConfig).toString());
	}
	...
	public static String Collection2JsonArrayData(Collection<Map<String,Object>> collection) {
		...
		return StringUtils.convertEspecial(result.append("]").toString());
	}
...
//	 * @return
//	 */
//	public static String javabean2jsonString(BaseAppException exception) {
//		JSONObject o = new JSONObject();
//		o.put("success", false);
//		o.put("errors", exception.getErrors());
//		return o.toString();
//	}
	/**
	 *
